...
public class ExcelCode {
	...
	@DataProvider(name = "NCRegister")
	public Object[][] getTNExcelRegisterData() throws Exception {
		Object[][] data = ExcelCode.readFromExcelSheetNCRegister("RegisterNC");
		return data;
	}
	
	public static Object[][] readFromExcelSheetNCRegister(String sheetName) throws Exception {
